...
class DataHolder:
    ...
    def __init__(self, file_name_and_path, test_train_ratio=0.2, train_valid_ratio=0.95):
        ...
        testing_x, testing_y = self.__data_loader.get_training_data()
        self.__testing = data_batcher.DataBatcher(testing_x, testing_y)
        validation_x, validation_y = self.__data_loader.get_training_data()
